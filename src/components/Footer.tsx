...
const Footer = () => {
  ...
  return (
    <footer className="main-footer" role="contentinfo" style={{ 
      background: '#000', 
      color: '#fff', 
      ...
      <div style={{ 
        ...
        <div className="container" style={{ 
          ...
          {['facebook', 'twitter-x', 'linkedin', 'youtube', 'wechat'].map((icon) => (
            <a key={icon} href="#" className="footer-social-link" style={{ 
              width: '32px', 
              height: '32px', 
      ...
      <div style={{ padding: '1rem 0 3rem 0', position: 'relative' }}>
        <div className="container" style={{ 
          ...
          <div style={{
            ...
            <a id="btn-back-to-top" className="btn-back-to-top" href="#" style={{ 
              background: brandColor, 
              width: '44px', 
              height: '44px', 
              display: 'flex', 
            ...
            <div className="footer-logo-partners-row" style={{ alignItems: 'flex-start' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', alignItems: 'flex-start' }}>
                ...
                <div className="footer-address-text" style={{ fontSize: '0.9375rem', fontWeight: 500, color: '#fff' }}>
                  ...
                  <span className="footer-address-span">MNSN Tower, 60 Dilkusha, Dhaka 1000, Bangladesh</span>
                </div>
              </div>
