  ...
  return (
    <section className="container" style={{ marginTop: "5rem", marginBottom: "1.75rem" }}>
      <div className="mission-vision-grid" style={{
        ...
        {/* Mission Card */}
        <div className="mvv-card mvv-card-left" style={{
          ...
          <div className="mission-vision-badge mvv-badge-left" style={{
        ...
        {/* Vision Card */}
        <div className="mvv-card mvv-card-right" style={{
          ...
          <div className="mission-vision-badge mvv-badge-right" style={{
