...
export const contentDefaults: ContentItem[] = [
  ...
  { section: "contact_information", itemKey: "address", title: "Office Address", body: "Dhaka Office:\nHouse 45, Road 12, Gulshan-2\nDhaka 1212, Bangladesh", metadata: { icon: "location" }, sortOrder: 1 },
  { section: "contact_information", itemKey: "phones", title: "Phone Numbers", body: "Bangladesh: +880 2 9884-5678\nUK: +44 20 7946-0958\nCanada: +1 647-361-8880", metadata: { icon: "phone" }, sortOrder: 2 },
  { section: "contact_information", itemKey: "email", title: "Email Address", body: "info@rowshanaraedu.com\nsupport@rowshanaraedu.com\nadmissions@rowshanaraedu.com", metadata: { icon: "email" }, sortOrder: 3 },
  { section: "contact_information", itemKey: "hours", title: "Office Hours", body: "Monday - Friday: 9:00 AM - 6:00 PM\nSaturday: 10:00 AM - 4:00 PM\nSunday: Closed", metadata: { icon: "clock" }, sortOrder: 4 },
